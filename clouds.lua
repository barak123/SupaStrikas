...
local clouds = {}
function clouds.new (skeletonData)
	...
	self.json.scale = 1.5
	self.skeletonData = self.json:readSkeletonDataFile("MenuClouds/Clouds.json")
	...
	function self.skeleton:createImage (attachment)
		...
		local newPart =  display.newImage("MenuClouds/" .. attachment.name .. ".png")
