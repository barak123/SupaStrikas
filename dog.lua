...
function dog.new (skeletonData)
	...
	self.skeletonData = self.json:readSkeletonDataFile("Dog.json")
	...
	function self.skeleton:createImage (attachment)
		...
		local newPart =  display.newImage("Dog/" .. attachment.name .. ".png")
...
--	self.state:setAnimationByName(0, "dog", true, 0)
	...
	function self:init()	
		...
		self.state:setAnimationByName(0, "Idel", true, 0) -- Bark
