...
pantsIdx =pantsIdx+  1
  ...
  items.pants[pantsIdx] = {}
    ...
    items.pants[pantsIdx].googleStoreId =  "rvstyle.little.barcapants"
      ...
      skinIdx =skinIdx +  1
      items.skins[skinIdx] = {}
      items.skins[skinIdx].name = "Ryu"
      items.skins[skinIdx].coinsCost = 300
      items.skins[skinIdx].image = "images/shop/skins/Asi.png"
      items.skins[skinIdx].id = "Asi" 
     ...
     skinIdx =skinIdx +  1
      ...
      local ballIdx = 1
      items.balls[ballIdx] = {}
      items.balls[ballIdx].name = "Ball"
      items.balls[ballIdx].coinsCost = 0
      items.balls[ballIdx].image = "balls/Ball001.png"
      items.balls[ballIdx].imgScale = 1  
      items.balls[ballIdx].id = "Ball001" 
      items.balls[ballIdx].packCategory = 9

      ballIdx =  ballIdx + 1
      items.balls[ballIdx] = {}
      items.balls[ballIdx].name = "Ball White"
      items.balls[ballIdx].coinsCost = 200
      items.balls[ballIdx].image = "balls/BallWhite.png"
      items.balls[ballIdx].imgScale = 1      
      items.balls[ballIdx].id = "BallWhite"       
      items.balls[ballIdx].packCategory = 4      
	  
      ballIdx =  ballIdx + 1
      items.balls[ballIdx] = {}
      items.balls[ballIdx].name = "Didas"
      items.balls[ballIdx].coinsCost = 300
      items.balls[ballIdx].image = "balls/Adidas.png"
      items.balls[ballIdx].imgScale = 1  
      items.balls[ballIdx].id = "Adidas" 
      items.balls[ballIdx].packCategory = 4

      ballIdx =  ballIdx + 1
      items.balls[ballIdx] = {}
      items.balls[ballIdx].name = "Feline"
      items.balls[ballIdx].coinsCost = 300
      items.balls[ballIdx].image = "balls/Feline.png"
      items.balls[ballIdx].imgScale = 1   
      items.balls[ballIdx].id = "Feline" 
      items.balls[ballIdx].packCategory = 4

      ballIdx =  ballIdx + 1
      items.balls[ballIdx] = {}
      items.balls[ballIdx].name = "Old Cup"
      items.balls[ballIdx].coinsCost = 400
      items.balls[ballIdx].image = "balls/OldCup.png"
      items.balls[ballIdx].imgScale = 1  
      items.balls[ballIdx].id = "OldCup"       
      items.balls[ballIdx].packCategory = 4

      ballIdx =  ballIdx + 1
      items.balls[ballIdx] = {}
      items.balls[ballIdx].name = "Basketball"
      items.balls[ballIdx].coinsCost = 500
      items.balls[ballIdx].image = "balls/Basketball.png"
      items.balls[ballIdx].imgScale = 1        
      items.balls[ballIdx].id = "Basketball"       
      items.balls[ballIdx].packCategory = 3

      ballIdx =  ballIdx + 1
      items.balls[ballIdx] = {}
      items.balls[ballIdx].name = "Football"
      items.balls[ballIdx].coinsCost = 500
      items.balls[ballIdx].image = "balls/Football.png"
      items.balls[ballIdx].imgScale = 1        
      items.balls[ballIdx].id = "Football"       
      items.balls[ballIdx].packCategory = 3
	  ...
	  ballIdx =  ballIdx + 1
      items.balls[ballIdx] = {}
      items.balls[ballIdx].name = "Brainz"
      items.balls[ballIdx].coinsCost = 700
      items.balls[ballIdx].image = "balls/Brainz.png"
      items.balls[ballIdx].imgScale = 1        
      items.balls[ballIdx].id = "Brainz"       
      items.balls[ballIdx].packCategory = 3

       ballIdx =  ballIdx + 1
      items.balls[ballIdx] = {}
      items.balls[ballIdx].name = "Watermelon"
      items.balls[ballIdx].coinsCost = 800
      items.balls[ballIdx].image = "balls/Watermelon.png"
      items.balls[ballIdx].imgScale = 1        
      items.balls[ballIdx].id = "Watermelon"       
      items.balls[ballIdx].packCategory = 3
       ...
       ballIdx =  ballIdx + 1
      items.balls[ballIdx] = {}
      items.balls[ballIdx].name = "Retro"
      items.balls[ballIdx].coinsCost = 900
      items.balls[ballIdx].image = "balls/RetroBall.png"
      items.balls[ballIdx].imgScale = 1        
      items.balls[ballIdx].id = "RetroBall"       
      items.balls[ballIdx].packCategory = 3
